...
public class SimpleTokenizer {
	...
	/**
	 * The size of the buffer should be considerably larger than the anticipated
	...
	/**
	 * Characters are read @code{BUFFER_LENGTH} characters at a time into
	 * @code{buf}.
	 */
	...
	static final char[] special_char = { '\u00E1', '\u00E0', '\u00E2', '\u00E5', '\u00E4', '\u00E9', '\u00E8',
			'\u00EA', '\u00ED', '\u00F1', '\u00F6', '\u00F4', '\u00FC', '\u00FA', '\u00F9', '\u00FB', '\u00C5',
			'\u00C4', '\u00D6', 165, 164, 8222, 182, 184, 732, 8211, 195 };

	/**
	 * What special characters should be translated into. NB: This array should
	 * have the same size as the one above!
	 */
	static final char[] translation = { 'a', 'a', 'a', '\u00E5', '\u00E4', 'e', 'e', 'e', 'i', 'n', '\u00F6', 'o',
			'\u00FC', 'u', 'u', 'u', '\u00E5', '\u00E4', '\u00F6', '\u00E5', '\u00E4', '\u00E4', '\u00F6', '\u00F6',
			'\u00F6', '\u00F6', '#' };
	...
	/**
	 * Normalizes strings by converting to lower-case and removing diacritics.
	 * Non-normalizable characters are translated into whitespace.
	 */
	...
	/**
	 * Normalizes letters by converting to lower-case and removing diacritics.
	 * This method is also used for checking whether a character can occur in a
	 * token or not.
	 * 
	 * @return code{true} if the (normalized counterpart of the) character can
	 *         occur within a token, and @code{false} otherwise.
	 */

	private static boolean normalize(char[] buf, int ptr) {
		char c = buf[ptr];
		if ((c >= '0' && c <= '9') || (c >= 'a' && c <= 'z')) {
			return true;
		} else if (c >= 'A' && c <= 'Z') {
	...
	/**
	 * @return the @code{true} if there are more tokens to be read, and
	...
	/**
	 * @return a String containing the next token, or @code{null} if there are
	 *         no more tokens.
	 */
