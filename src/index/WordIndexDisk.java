...
public class WordIndexDisk implements Index {
	 ...
	 * @param dir the directory with the cache.
	 */
	public WordIndexDisk(String dir) {
	...
	public static void main(String[] args) {
		...
		WordIndexDisk index = new WordIndexDisk("../index");
	 ...
	 */
	public static File wordToFileName(String word, File directory) {
		try { 
